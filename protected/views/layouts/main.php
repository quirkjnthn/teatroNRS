        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Odonto</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-users"></i> Usuarios <span class="fa fa-chevron-down"></span></a>
                    ...
                    ?>
                      <li><a href="<?php echo Yii::app()->createUrl("administrador/admin"); ?>">Administrador</a></li>
                      <li><a href="<?php echo Yii::app()->createUrl("reseller/admin"); ?>">Reseller</a></li>
                    <?php } ?>
                  ...
                  <li><a href="<?php echo Yii::app()->createUrl("aplicacion/admin"); ?>"><i class="fa fa-desktop"></i> Aplicaciones</a></li>
